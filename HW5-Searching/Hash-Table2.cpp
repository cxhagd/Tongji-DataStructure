...
unsigned long long int prime[maxn];//存储筛出来的素数 
unsigned long long int vispr[maxn];
bool vis[maxn] = { 0 };//散列表当中的位置 
unsigned long long int inipri(unsigned long long int prime[maxn], unsigned long long int vispr[maxn]) {//返回的是素数个数 
